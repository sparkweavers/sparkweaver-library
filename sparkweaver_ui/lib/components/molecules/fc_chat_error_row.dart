...
/// Inline row for a message list, shown in place of a message that failed to send.
/// Holds no chat types; the caller supplies the text and the reconnect callback.
