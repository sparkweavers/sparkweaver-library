...
Widget primaryBadge(BuildContext context) {
  return Center(
    child: FcBadgeVariants.primary(text: 'Primary', icon: Icons.star, context: context),
  );
}
...
Widget successBadge(BuildContext context) {
  return Center(
    child: FcBadgeVariants.success(text: 'Success', icon: Icons.check_circle, context: context),
  );
}
...
Widget warningBadge(BuildContext context) {
  return Center(
    child: FcBadgeVariants.warning(text: 'Warning', icon: Icons.warning, context: context),
  );
}
...
Widget errorBadge(BuildContext context) {
  return Center(
    child: FcBadgeVariants.error(text: 'Error', icon: Icons.error, context: context),
  );
}
