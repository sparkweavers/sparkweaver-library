...
final _sampleMessages = [
  const ChatMessageData(content: 'Hello! How can I help you today?', isUser: false),
  const ChatMessageData(content: 'I have a question about the product.', isUser: true),
...
Widget emptyConversation(BuildContext context) {
  return const FcConversationList(
    messages: [],
  );
}
