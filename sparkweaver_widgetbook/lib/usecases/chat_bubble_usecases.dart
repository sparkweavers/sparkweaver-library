...
Widget aiMessageWithFiles(BuildContext context) {
  return const Padding(
    ...
    child: FcChatBubble(
      message:
          'I found information in the following documents that might help:',
      isUser: false,
      referencedFiles: [
        'biology_notes.pdf',
  ...
  return ListView(
    ...
    children: [
      ...
      FcChatBubbleVariants.ai(
        message:
            'I\'ll help you create flashcards from your biology notes. I found these documents:',
      ...
      FcChatBubbleVariants.ai(
        message:
            'Creating flashcards from cell_biology.txt. I\'ll generate questions about cell structure, organelles, and functions.',
...
Widget longMessage(BuildContext context) {
  return const Padding(
    ...
    child: FcChatBubble(
      message:
          'This is a much longer message that demonstrates how the chat bubble handles wrapping text. '
