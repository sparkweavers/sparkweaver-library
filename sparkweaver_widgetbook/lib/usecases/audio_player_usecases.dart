...
Widget loadingAudio(BuildContext context) {
  return const Center(child: FcAudioPlayer(state: FcAudioPlayerState.loading));
}

@widgetbook.UseCase(name: 'Playing State', type: FcAudioPlayer)
Widget playingAudio(BuildContext context) {
  return Center(
    child: FcAudioPlayer(state: FcAudioPlayerState.playing, onPause: () {}),
  );
}
...
Widget pausedAudio(BuildContext context) {
  return Center(
    child: FcAudioPlayer(state: FcAudioPlayerState.paused, onPlay: () {}),
  );
}
