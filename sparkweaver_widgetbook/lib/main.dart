...
class WidgetbookApp extends StatelessWidget {
  ...
  /// Creates a light theme with Sparkweaver design system colors
  ...
  /// Creates a dark theme with Sparkweaver design system colors
  ThemeData _buildDarkTheme() {
    final colors = SparkweaverTheme.dark();
    ...
    return Widgetbook.material(
      ...
      addons: [
        ...
        ThemeAddon(
          themes: [
            WidgetbookTheme(
              name: 'Light (Sparkweaver)',
              data: _buildLightTheme(),
            ),
            WidgetbookTheme(
              name: 'Dark (Sparkweaver)',
